"""Event archival sweep: hide inactive events and permanently close events that
have been idle for a long time. Never deletes rows or article bodies."""
...
async def run_archival_sweep(session: AsyncSession) -> dict[str, Any]:
    """Archive enriched events gone quiet 72h+, and permanently close events
    archived for a further 7 days (10 days total)."""
    ...
    metrics = {"n_archived": n_archived, "n_closed": n_closed}
