...
| **Geocode** region accuracy | `eval_geocode` | **0.000** (0/17) | **~0.53–0.67** (noisy) | **0.789** (15/19) | — | — | **0.750** (12/16) | **0.750** (12/16) | — | **0.706** (12/17) | ↑; 4 misses are the national/venueless class → A5 target |
| **Geocode** median distance err | `eval_geocode` | **112.6 km** (n=17) | **2.6 km** (successful pins) | **3.2 km** (n=19) | — | — | **2.9 km** (n=16) | **2.9 km** (n=16) | — | **4.7 km** (n=17) | venue-level, full domestic coverage |
...
>
> M7's remaining scope (Kallikratis δήμος `municipalities` table, Tasks 2–6) is not started.
